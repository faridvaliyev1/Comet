...
import glob
import pandas as pd
os.chdir(os.getcwd()+"/Data/wide_property_table_100M_csv")
...
for f in all_filenames:
    frames.append(pd.read_csv(f,names=headers,usecols=headers,header=0,index_col=False))
...
#export to csv
os.chdir(os.getcwd())
frame.to_csv("/Users/farid/Desktop/Projects/Comet/DataCentric/Data/combined_100M.csv", index=False, encoding='utf-8-sig')
